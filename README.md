...
- Click-to-expand subtrees in browse mode
...
covering ICD-10-GM and OPS for years 2014–2026.
The raw XML files are not included in this repository. To regenerate the data:
...
│   └── netlify.toml
└── scripts/
    └── export_data.py # parquet → catalogue.json.gz
```
